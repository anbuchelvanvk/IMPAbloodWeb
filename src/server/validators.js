...
export const schemas = {
  register: z.object({
    ...
    isFoodDonor: z.boolean().optional(),
    isEyeDonor: z.boolean().optional(),
    bloodGroup: z.string().trim().max(10).nullable().optional(),
    fssaiNumber: z.string().trim().max(100).nullable().optional(),
    trustName: z.string().trim().max(140).nullable().optional(),
    foodFrequency: z.string().trim().max(50).nullable().optional(),
    foodType: z.string().trim().max(50).nullable().optional(),
    eyeDonationConsent: z.boolean().nullable().optional(),
    familyInformed: z.boolean().nullable().optional(),
    doctorName: z.string().trim().max(140).nullable().optional(),
    doctorNumber: z.string().trim().max(20).nullable().optional(),
  ...
  updateProfile: z.object({
    ...
    doctorName: z.string().trim().max(140).nullable().optional(),
    doctorNumber: z.string().trim().max(20).nullable().optional(),
    guardianName: z.string().trim().max(140).nullable().optional(),
    guardianContact: z.string().trim().max(20).nullable().optional(),
    state: z.string().trim().min(1).max(100).optional(),
    district: z.string().trim().min(1).max(100).optional(),
  ...
  promoteUser: z.object({ userId: z.string().min(1) }),
